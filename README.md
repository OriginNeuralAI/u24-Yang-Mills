...
[![Rust](https://img.shields.io/badge/Rust-Isomorphic_Engine-DEA584.svg)](#engine-experiments)
...
The [Isomorphic Engine](#engine-experiments) (Rust, 12 parallel CPU solvers, sparse CSR pipeline) provides high-dimensional computational verification:
...
All rights reserved. See [LICENSE](LICENSE) for permitted academic and research uses.
